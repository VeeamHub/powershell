<#
.SYNOPSIS
	Upgrades Veeam Environment to v12 GA
...
.EXAMPLE
	Update-Veeam.ps1 -ISO "C:\VeeamBackup&Replication_12.0.0.1420_20230223.iso" -License "C:\license.lic"
...
.NOTES
    ...
    13. Veeam Agent for Linux Redistributable
    14. Veeam Agent for MacOS Redistributable
    15. Veeam Agent for Microsoft Windows Redistributable
    16. Veeam Agent for Unix Redistributable
...
if ($iso -eq "download") {
    try {
        $iso = "$logFolder\VeeamBackup&Replication_12.0.0.1420_20230209.iso"
        ...
        if (Test-Path $iso) {
            ...
            Start-BitsTransfer -Source "https://download2.veeam.com/VBR/v12/VeeamBackup&Replication_12.0.0.1420_20230209.iso" -Destination $iso
