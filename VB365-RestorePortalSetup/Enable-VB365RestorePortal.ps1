...
.PARAMETER URL
  Specifies the web address that will be used to access Restore Portal
...
.EXAMPLE
	Enable-VB365RestorePortal.ps1 -AppId 37a0f8e1-97bd-4804-ba69-bde1db293273 -AppThumbprint ccf2c168a2a4253532e27dba7e0093d6b6351f93 -PortalUri "https://portal.com:4443"

	Description
	-----------
	Enables the VB365 Restore Portal using the specified Enterprise Application ID and certificate thumbprint. The restore portal will only allow access from 'https://portal.com:4443'.

.EXAMPLE
	Enable-VB365RestorePortal.ps1 -AppId 37a0f8e1-97bd-4804-ba69-bde1db293273 -AppThumbprint ccf2c168a2a4253532e27dba7e0093d6b6351f93 -PortalUri "https://portal.com:4443" -Port 443
...
.EXAMPLE
	Enable-VB365RestorePortal.ps1 -AppId 37a0f8e1-97bd-4804-ba69-bde1db293273 -AppThumbprint ccf2c168a2a4253532e27dba7e0093d6b6351f93 -PortalUri "https://portal.com:4443" -SaveCerts
...
.EXAMPLE
	Enable-VB365RestorePortal.ps1 -AppId 37a0f8e1-97bd-4804-ba69-bde1db293273 -AppThumbprint ccf2c168a2a4253532e27dba7e0093d6b6351f93 -PortalUri "https://portal.com:4443" -SaveCerts -Verbose
...
try {
  ...
  Set-VBORestorePortalSettings -EnableService -ApplicationId $AppId -CertificateFilePath "$folder\vb365-restore-portal.pfx" -CertificatePassword $securestring -PortalUri $URL | Out-Null
