<#
.SYNOPSIS
Veeam Service Provider Console (VSPC) Create new company & Cloud Connect tenant
...
Description
-----------
When multiple Cloud Connect sites exist, the SiteName parameter must be used to specify which site the new tenant will be created under.
...
Write-Verbose ("New Cloud Connect tenant '{0}' created successfully." -f $newTenant.name)
